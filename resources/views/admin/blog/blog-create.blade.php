        ...
        <div class="card-body">
          <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <div class="d-flex align-items-center gap-4">
                ...
                <img id="preview" src="{{ asset('images/no-image.png') }}" alt="Preview"
                  class="rounded shadow-sm border" style="max-height: 150px; max-width: 200px; object-fit: cover;">
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <select class="form-select @error('kategori') is-invalid @enderror" id="example-select" name="kategori">
